...
router.post('/',async function(req, res, next) {
    ...
    .then(pdfData => {
        ...
        pool.query('INSERT INTO pdfs (author_name, subject,term,project_name,advisor_name,jury_names) VALUES ($1,$2,$3,$4,$5,$6)', [author_name,subject_name,term_name,project_name,advisor_name,jury_names], (error, results) => {
            if (error) {
              throw error
            }
          })
